...
import { GetAvailableCredits } from "@/lib/actions/billing/getAvailableCredits";
import { ArrowLeftRightIcon, CoinsIcon } from "lucide-react";
import { Suspense } from "react";
import CreditsPurchase from "./_components/CreditsPurchase";
import { Period } from "@/types/analytics";
import { GetCreditsUsageInPeriod } from "@/lib/actions/analytics/getCreditsUsageInPeriod";
import CreditUsageChart from "./_components/CreditUsageChart";
import { GetUserPurchaseHistory } from "@/lib/actions/billing/getUserPurchaseHistory";
...
async function BalanceCard() {
  ...
  return (
    <Card className="bg-gradient-to-br from-primary/10 via-primary/5 to-background border-primary/20 shadow-lg flex justify-between overflow-hidden flex-col">
